...
-- Type: full
-- Generated at: 2026-06-30 09:00:34
...
('1','1','in','2026-06-25 09:29:10','manual','morning',NULL,'2026-06-25 10:29:10'),
('2','1','out','2026-06-29 09:35:34','manual','morning',NULL,'2026-06-29 10:35:34');
...
('1','1','receipt_skipped_on_close','rent','1',NULL,NULL,'{\"closing_paid_amount\":1333,\"closing_payment_method\":\"cash\",\"closed_at\":\"2026-04-29 07:31:10\"}','2026-04-29 08:31:10'),
...
('3','1','payment_created','payment','1',NULL,NULL,'{\"rent_id\":1,\"amount\":1333.33,\"type\":\"in\"}','2026-04-29 08:33:13'),
('4','1','receipt_skipped_on_close','rent','2',NULL,NULL,'{\"closing_paid_amount\":1333,\"closing_payment_method\":\"cash\",\"closed_at\":\"2026-04-30 07:03:36\"}','2026-04-30 08:03:36'),
...
('6','1','payment_created','payment','2',NULL,NULL,'{\"rent_id\":2,\"amount\":1333,\"type\":\"in\"}','2026-04-30 08:03:36'),
('7','1','receipt_skipped_on_close','rent','3',NULL,NULL,'{\"closing_paid_amount\":120000,\"closing_payment_method\":\"cash\",\"closed_at\":\"2026-05-23 10:35:08\"}','2026-05-23 11:35:08'),
...
('9','1','payment_created','payment','3',NULL,NULL,'{\"rent_id\":3,\"amount\":120000,\"type\":\"in\"}','2026-05-23 11:35:08'),
('10','1','payment_created','payment','4',NULL,NULL,'{\"rent_id\":2,\"amount\":0.33,\"type\":\"in\"}','2026-05-23 13:36:51'),
('11','1','rent_closed','rent','6',NULL,NULL,'{\"total_amount\":2500}','2026-05-24 08:54:44'),
('12','5','payment_created','payment','5',NULL,NULL,'{\"rent_id\":6,\"amount\":2500,\"type\":\"in\"}','2026-05-24 08:55:27'),
('13','1','payment_created','payment','7',NULL,NULL,'{\"rent_id\":7,\"amount\":77500,\"type\":\"in\"}','2026-06-23 10:44:21'),
('14','1','rent_closed','rent','7',NULL,NULL,'{\"total_amount\":77500}','2026-06-23 10:54:14'),
('15','1','payment_created','payment','8',NULL,NULL,'{\"rent_id\":5,\"amount\":77500,\"type\":\"in\"}','2026-06-23 11:13:08'),
('16','1','rent_closed','rent','5',NULL,NULL,'{\"total_amount\":77500}','2026-06-23 11:20:15'),
('17','1','payment_created','payment','9',NULL,NULL,'{\"rent_id\":4,\"amount\":77500,\"type\":\"in\"}','2026-06-23 11:25:03'),
('18',NULL,'rent_closed_auto','rent','5',NULL,NULL,'{\"total_amount\":77500,\"trigger\":\"payment_paid_in_full\"}','2026-06-23 11:47:11'),
('19','1','rent_closed_auto','rent','4',NULL,NULL,'{\"total_amount\":77500,\"trigger\":\"payment_paid_in_full\"}','2026-06-23 11:50:40'),
('20','1','payment_created','payment','10',NULL,NULL,'{\"rent_id\":4,\"amount\":77500,\"type\":\"in\"}','2026-06-23 11:50:40'),
('21','1','payment_created','payment','11',NULL,NULL,'{\"rent_id\":11,\"amount\":5000,\"type\":\"in\"}','2026-06-24 08:33:03'),
('22','1','rents_archived','rents',NULL,NULL,NULL,'{\"count\":7}','2026-06-24 08:34:06'),
('23','1','collection_followup_created','rent','11',NULL,NULL,'{\"followup_id\":1,\"contact_type\":\"call\",\"outcome\":\"promise_to_pay\"}','2026-06-24 08:37:13'),
('24','1','rent_closed','rent','12',NULL,NULL,'{\"total_amount\":7000}','2026-06-24 09:05:24'),
('25','1','payment_created','payment','12',NULL,NULL,'{\"rent_id\":12,\"amount\":3500,\"type\":\"in\"}','2026-06-24 09:05:25'),
('26','1','rent_closed','rent','13',NULL,NULL,'{\"total_amount\":15000}','2026-06-24 09:19:30'),
('27','1','rent_closed','rent','14',NULL,NULL,'{\"total_amount\":12500}','2026-06-24 09:34:40'),
('28','1','payment_created','payment','13',NULL,NULL,'{\"rent_id\":14,\"amount\":6250,\"type\":\"in\"}','2026-06-24 09:34:41'),
('29','1','rent_closed','rent','16',NULL,NULL,'{\"total_amount\":5000}','2026-06-24 10:20:15'),
('30','1','payment_created','payment','14',NULL,NULL,'{\"rent_id\":16,\"amount\":5000,\"type\":\"in\"}','2026-06-24 10:20:29'),
('31','1','rent_closed','rent','15',NULL,NULL,'{\"total_amount\":5000}','2026-06-24 10:20:53'),
('32','1','payment_created','payment','15',NULL,NULL,'{\"rent_id\":15,\"amount\":5000,\"type\":\"in\"}','2026-06-24 10:20:53'),
('33','1','payment_created','payment','16',NULL,NULL,'{\"rent_id\":13,\"amount\":15000,\"type\":\"in\"}','2026-06-25 08:21:11'),
('34','1','rent_closed','rent','17',NULL,NULL,'{\"total_amount\":5000}','2026-06-25 08:22:23'),
('35','1','payment_created','payment','17',NULL,NULL,'{\"rent_id\":17,\"amount\":5000,\"type\":\"in\"}','2026-06-25 08:22:23'),
('36','1','rent_closed','rent','18',NULL,NULL,'{\"total_amount\":5000}','2026-06-25 09:36:44'),
('37','1','payment_created','payment','18',NULL,NULL,'{\"rent_id\":18,\"amount\":5000,\"type\":\"in\"}','2026-06-25 09:36:45'),
('38','5','shift_closed','shift_closing','2',NULL,NULL,'{\"shift_date\":\"2026-06-29\",\"expected_amount\":0,\"actual_amount\":100,\"difference\":100,\"cash_total\":0,\"transfer_total\":0}','2026-06-29 08:55:46'),
('39','5','shift_difference_detected','shift_closing','2',NULL,NULL,'{\"shift_date\":\"2026-06-29\",\"difference\":100,\"expected_amount\":0,\"actual_amount\":100}','2026-06-29 08:55:46'),
('40','5','shift_closed','shift_closing','2',NULL,NULL,'{\"shift_date\":\"2026-06-29\",\"expected_amount\":0,\"actual_amount\":100,\"difference\":100,\"cash_total\":0,\"transfer_total\":0}','2026-06-29 08:56:05'),
('41','5','shift_difference_detected','shift_closing','2',NULL,NULL,'{\"shift_date\":\"2026-06-29\",\"difference\":100,\"expected_amount\":0,\"actual_amount\":100}','2026-06-29 08:56:05'),
('42','1','rent_closed','rent','11',NULL,NULL,'{\"total_amount\":60000}','2026-06-29 09:02:25'),
('43','1','payment_created','payment','19',NULL,NULL,'{\"rent_id\":11,\"amount\":55000,\"type\":\"in\"}','2026-06-29 09:02:25'),
('46','1','permissions_changed','user','5','{\"screen_permissions\":{\"dashboard\":true,\"rents\":true,\"clients\":true,\"equipment\":true,\"payments\":false,\"receipts\":false,\"reports\":false,\"hr\":false,\"attendance\":false,\"shifts\":false,\"backup\":false,\"settings\":true,\"user_management\":false,\"print\":false,\"export\":false,\"audit_logs\":false,\"financial_reports\":false}}','{\"screen_permissions\":{\"dashboard\":true,\"rents\":true,\"clients\":true,\"equipment\":true,\"payments\":false,\"receipts\":false,\"reports\":false,\"hr\":false,\"attendance\":false,\"shifts\":true,\"backup\":false,\"settings\":true,\"user_management\":false,\"print\":false,\"export\":false,\"audit_logs\":false,\"financial_reports\":false}}',NULL,'2026-06-29 09:54:13'),
...
('9','در يل 1','',NULL,'available','5000.00','0.00','0.00','60','2026-06-23','0.00','0.00','0.00','0.00','365','0.00','0.00','2026-06',NULL,'2026-06-23 11:22:46','1','5000'),
...
('1','admin','admin123','admin','2026-01-11 10:30:53','1',NULL,NULL,NULL,NULL,NULL),
...
('6','محمد','12345','employee','2026-06-29 08:40:50','1',NULL,NULL,NULL,'{\"contract_hour_pricing_mode\":\"inherit\",\"contract_payment_receipt_mode\":\"inherit\",\"user_management\":false,\"backup\":false,\"reports\":false,\"hr\":false,\"attendance\":true,\"equipment\":true,\"clients\":true,\"rents\":true,\"payments\":true,\"receipts\":true,\"shifts\":true,\"settings\":false,\"dashboard\":true,\"print\":true}',NULL);
